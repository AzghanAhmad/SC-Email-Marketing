...
@Component({
    ...
    <div class="auth-root">
      <header class="nav" [class.scrolled]="navScrolled">
        ...
        <div class="nav-mobile-menu" [class.open]="mobileMenuOpen">
          <a routerLink="/login" (click)="mobileMenuOpen=false">Log In</a>
  ...
  styles: [`
    ...
    .nav-inner { max-width:1200px;margin:0 auto;padding:.85rem 1.5rem;display:flex;align-items:center;justify-content:space-between;gap:1rem; }
    ...
    .nav-mobile-menu a:hover { background:rgba(255,255,255,.07);color:white; }
...
export class SignupComponent {
  ...
  navScrolled = false; mobileMenuOpen = false;
