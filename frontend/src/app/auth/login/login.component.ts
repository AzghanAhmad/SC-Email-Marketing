...
@Component({
    ...
    <div class="auth-root">
      ...
      <section class="auth-hero">
        <div class="auth-hero-inner">
          <div class="hero-left">
            <h1 class="hero-title anim-up">Grow Your<br><span class="gradient-text">Reader List</span></h1>
            <p class="hero-sub anim-up d2">
              The email marketing platform built for authors. Send beautiful campaigns, automate your flows, and grow your readership with powerful analytics.
            </p>
            ...
            <div class="hero-stats anim-up d4">
              <div class="hero-stat"><span class="hs-num">8,400+</span><span class="hs-label">Subscribers managed</span></div>
              <div class="hero-stat-div"></div>
              <div class="hero-stat"><span class="hs-num">54%</span><span class="hs-label">Avg open rate</span></div>
              <div class="hero-stat-div"></div>
              <div class="hero-stat"><span class="hs-num">3 flows</span><span class="hs-label">Running 24/7</span></div>
            </div>
          </div>
          ...
          <div class="form-side anim-up d2">
            <div class="auth-card">
              ...
              <p class="card-subtitle">Sign in to your ScribeCount Email dashboard</p>
  ...
  styles: [`
    ...
    .hs-num { font-size:1.25rem;font-weight:800;color:white;letter-spacing:-.02em; }
    ...
    .auth-input.input-error { border-color:#ef4444;box-shadow:0 0 0 3px rgba(239,68,68,.1); }
