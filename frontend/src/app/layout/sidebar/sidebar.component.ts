  ...
  constructor(
    ...
    this.analyticsGroup = {
      ...
      children: [
        ...
        { label: 'Link Clicks', route: '/analytics/link-clicks', icon: s('<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.75" width="14" height="14"><path d="M3 3l7.07 16.97 2.51-7.39 7.39-2.51L3 3z"/><path d="M13 13l6 6"/></svg>') },
