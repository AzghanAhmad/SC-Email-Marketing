...
export const RETENTION_FLOWS: Flow[] = [
...

  {
    ...
    description: 'Low-pressure check-in for subscribers who have gone quiet — 60, 90, or 180 days inactive. Either rekindles the relationship or cleanly confirms they have moved on. A smaller engaged list always outperforms a large unresponsive one.',
    status: 'paused', triggers: 89,
    goalExit: 'Reader opens or clicks any email — re-engagement confirmed',
    steps: [
      { id: 's1', type: 'trigger', label: 'Trigger', detail: 'No open or click in 90 days' },
      { id: 's2', type: 'email', label: 'Miss You Email', detail: 'Subject: Still there? I miss you... — Low-pressure check-in. Remind them why they subscribed, share what they have missed, or offer compelling incentive: free story or exclusive discount that makes re-engaging feel worthwhile. Goal: rekindle relationship with lapsed reader or cleanly confirm they have moved on.' },
      { id: 's3', type: 'wait', label: 'Wait 7 Days', detail: 'Delay: 7 days' },
      { id: 's4', type: 'condition', label: 'Opened?', detail: 'If opened — re-engaged tag; if not — final email' },
      { id: 's5', type: 'email', label: 'Last Chance Email', detail: 'Subject: I am about to let you go... — Final notice before removal from active list' },
      { id: 's6', type: 'condition', label: 'Still Silent?', detail: 'If no response — remove from active list cleanly' },
      { id: 's7', type: 'goal-exit', label: 'Goal Exit', detail: 'Reader opens or clicks — exits re-engagement, stays on list' },
    ]
  },
  {
    ...
    steps: [
      { id: 's1', type: 'trigger', label: 'Trigger', detail: 'Subscriber anniversary date, birthday, or reading milestone reached' },
      { id: 's2', type: 'email', label: 'Milestone Email', detail: 'Subject: One year together — thank you — Lead with acknowledgment of milestone before anything else so reader feels seen rather than marketed to. Offer small meaningful gift: discount, free short story, or early access to something upcoming. Goal: surprise and delight loyal readers at unexpected moments, deepen emotional investment in author brand, demonstrate relationship extends beyond the transaction.' },
      { id: 's3', type: 'goal-exit', label: 'Goal Exit', detail: 'Email opened — milestone acknowledged, loyalty deepened' },
    ]
  },
  {
